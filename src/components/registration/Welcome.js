        ...
        <div className="welcome-body">
          ...
          <div className=" col-lg-5">
            <div className="welcome-auth-view">
              <div className="tab">
                <div id="sign-in-corner" className="tab-bar">
                  <button className="text-center" onClick={changeAuthType}>
                    Sign In
                  </button>
                </div>
                <div id="register-corner" className="tab-bar center-block">
                  <button onClick={changeAuthType}>Register</button>
                </div>
              </div>
